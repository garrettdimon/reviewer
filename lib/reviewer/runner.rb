...
module Reviewer
  ...
  class Runner
    ...
    def run
      # Show which tool is running (unless in JSON mode)
      identify_tool unless Reviewer.arguments.json?

      # Use the provided strategy to run the command
      execute_strategy

      # If it failed, display guidance to help them get back on track (unless in JSON mode)
      guidance.show unless success? || Reviewer.arguments.json?
